...
public class SimulatedAnnealingTravelSalesMan<T, R extends Number & Comparable<R>> extends Thread
{
	/**
	 ...
	 *            configuration
	 */
	public SimulatedAnnealingTravelSalesMan(List<T> objects, Function<List<T>, R> fitFunc)
	{
